...
class CartOrderUserWait extends StatefulWidget {
  final Order? order;
  final List<CartModel>? products;
  final Color? col;
  const CartOrderUserWait({Key? key, this.order, this.products, this.col})
      : super(key: key);

  @override
  State<CartOrderUserWait> createState() => _CartOrderUserWaitState();
}

class _CartOrderUserWaitState extends State<CartOrderUserWait> {
  @override
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (ctx) => OrderUserDetailsWait(order: widget.order),
              ),
            );
          },
          child: Container(
