...
class OrderUserDetailsWait extends StatefulWidget {
  final Order? order;

  OrderUserDetailsWait({
    this.order,
  });

  @override
  State<OrderUserDetailsWait> createState() => _OrderUserDetailsWaitState();
}

class _OrderUserDetailsWaitState extends State<OrderUserDetailsWait> {
  List<CartModel> c = [];
