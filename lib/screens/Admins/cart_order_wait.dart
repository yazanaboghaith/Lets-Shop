...
class CartOrderWait extends StatefulWidget {
  final Order? order;
  final List<CartModel>? products;
  const CartOrderWait({Key? key, this.order, this.products}) : super(key: key);

  @override
  State<CartOrderWait> createState() => _CartOrderWaitState();
}

class _CartOrderWaitState extends State<CartOrderWait> {
  @override
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (ctx) => OrderDetails(order: widget.order),
              ),
            );
          },
          child: Container(
